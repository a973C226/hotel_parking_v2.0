                    ...
                    <div className="container flex flex-col items-center gap-10">
                        ...
                        <Card className="flex flex-col gap-4 sm:px-16 px-4 sm:py-16 py-10 shadow-md md:mx-auto mx-0 items-center">
                            <div className="flex rounded-md shadow-sm" role="group">
                                <button type="button" onClick={() => {setCardState(1)}} className="sm:px-4 px-1 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                    Данные профиля
                                </button>
                                <button type="button" onClick={() => {setCardState(2)}} className="sm:px-4 px-1 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                    Транспорт
                                </button>
                                <button type="button" onClick={() => {setCardState(3)}} className="sm:px-4 px-1 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                    История операций
                                </button>
                            </div>
