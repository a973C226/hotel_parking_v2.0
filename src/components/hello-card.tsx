...
const HelloCard = () => {
    return (
        <div className="lg:w-[800px] absolute left-0 lg:items-start items-center lg:bg-slate-300/50 bg-slate-300/80 p-5 lg:pl-40 pl-10 rounded-lg">
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:ring-4 focus:ring-blue-300">
                Узнайте больше
